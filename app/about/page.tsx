...
export default function About() {
  return <main>
    <SiteHeader />
    <PageHero eyebrow={`Established in ${company.established}`} title="A stronger link between trusted brands and better healthcare." copy="Your single window partner for anything healthcare. Our brand is created for quality backed by service. We live and breathe the Indian healthcare market. In-depth understanding of the industry and expert knowledge are our core competitive advantage. We maintain strong professional relations with the Ministry of Health regulatory board to ensure that all local requirements and regulatory affairs are met promptly. Every product line we cater to is manufactured to internationally recognised standards, including ISO 13485:2016 quality management systems and CE marking under the European Medical Device Directives." />
